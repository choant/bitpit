...
void LevelSetObject::exchangeGhosts(){
    ...
    startExchange(m_kernelPtr->getMesh()->getGhostExchangeSources(), dataCommunicator.get());
    completeExchange(m_kernelPtr->getMesh()->getGhostExchangeTargets(), dataCommunicator.get());
}
